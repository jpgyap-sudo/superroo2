...
const DESCRIPTION =
	"Privacy policy for SuperRoo Cloud and marketing website. Learn how we handle your data and protect your privacy."
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						SuperRoo Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how SuperRoo, Inc. (&quot;SuperRoo,&quot; &quot;we,&quot;
						&quot;our,&quot; or &quot;us&quot;) collects, uses, and shares information when you:
					</p>
					<ul className="lead">
						<li>
							browse any page under <strong>superroo.com</strong> (the <em>Marketing Site</em>); and/or
						</li>
						<li>
							create an account for, sign in to, or otherwise use <strong>SuperRoo Cloud</strong> at{" "}
							<strong>app.superroo.com</strong> or through the SuperRoo extension while authenticated to
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the SuperRoo extension <strong>without</strong> connecting to a Cloud account,
							your data is governed by the standalone{" "}
							<a
								href="https://github.com/SuperRooInc/SuperRoo/blob/main/PRIVACY.md"
								target="_blank"
								rel="noopener noreferrer"
								className="text-primary hover:underline">
								SuperRoo Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>
								Your source code does not transit SuperRoo servers unless you explicitly choose SuperRoo
								as a model provider (proxy mode).
							</strong>{" "}
							When SuperRoo Cloud is your model provider, your code briefly transits SuperRoo servers only
							...
							TLS—to the model you select. SuperRoo never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in SuperRoo Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate SuperRoo Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure SuperRoo Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or SuperRoo (proxy
										mode; transit‑only) when you select SuperRoo as the provider
									</td>
									<td className="border border-border px-4 py-2">
										SuperRoo servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										SuperRoo Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										SuperRoo servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on SuperRoo servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside SuperRoo Cloud (User Menu &rarr; My Settings
							&rarr; Open Profile).
						</li>
						<li>
					...
					<p>
						...
						<a href="mailto:privacy@superroo.com" className="text-primary hover:underline">
							privacy@superroo.com
						</a>
						.
					</p>
				</div>
