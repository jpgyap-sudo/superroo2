	...
	return (
		<div className="mx-auto flex max-w-screen-lg flex-col gap-8 p-8">
			<div className="flex flex-col gap-4">
				<div>
					SuperRoo tests each frontier model against{" "}
					<a href="https://github.com/SuperRooInc/SuperRoo-Evals" className="underline">
				...
				<div>
					...
					<a href="https://discord.gg/superroo" className="underline">
						Discord
					</a>
					.
				</div>
