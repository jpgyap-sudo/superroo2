...
const faqs: FAQItem[] = [
	{
		question: "What exactly is SuperRoo?",
		answer: (
			<>
				SuperRoo is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does SuperRoo differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				SuperRoo is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: SuperRoo is{" "}
	...
	{
		question: "Is SuperRoo really free?",
		answer: (
			<>
				Yes! SuperRoo is completely free and open-source. You&apos;ll only pay for the AI model usage if you use
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because SuperRoo is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .rooignore to exclude sensitive files, and you can also run SuperRoo with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does SuperRoo support?",
		answer: (
			<>
				SuperRoo is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows SuperRoo&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does SuperRoo support my programming language?",
		answer: (
			<>
				Likely yes! SuperRoo supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				Install SuperRoo from the{" "}
				<a
					href="https://marketplace.visualstudio.com/items?itemName=SuperRoo.superroo"
					target="_blank"
				...
				<a
					href="https://docs.superroo.com/tutorial-videos"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. SuperRoo uses efficient strategies (like partial-file analysis, summarization, or
	...
	},
	{
		...
		answer: (
			<>
				Yes. SuperRoo was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because SuperRoo is fully open-source, it&apos;s auditable—you can review exactly how it
	...
	{
		question: "Can SuperRoo run commands and tests automatically?",
		answer: (
			<>
				Yes! One of SuperRoo&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				SuperRoo shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask
	...
	{
		question: "Can I contribute to SuperRoo?",
		answer: (
			<>
				Yes, please do! SuperRoo is open-source on{" "}
				<a
					href="https://github.com/SuperRooInc/SuperRoo"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					GitHub
				...
				<a
					href="https://discord.gg/superroo"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Discord
				...
				and{" "}
				<a
					href="https://reddit.com/r/SuperRoo"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Reddit
	...
	},
	{
		...
		answer: (
			<>
				...
				<a
					href="https://www.youtube.com/@SuperRooYT"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					YouTube
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about SuperRoo and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>
