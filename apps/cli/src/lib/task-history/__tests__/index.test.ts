import { readTaskSessionsFromStoragePath } from "@superroo/core/cli"
...
vi.mock("@superroo/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@superroo/core/cli")>()
	return {
		...actual,
