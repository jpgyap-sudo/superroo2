/**
 * ExtensionHost - Loads and runs the SuperRoo extension in CLI mode
 *
...
import { createVSCodeAPI, IExtensionHost, ExtensionHostEventMap, setRuntimeConfigValues } from "@superroo/vscode-shim"
import { DebugLogger, setDebugLogEnabled } from "@superroo/core/cli"
...
export interface ExtensionHostInterface extends IExtensionHost<ExtensionHostEventMap> {
	...
	runTask(prompt: string, taskId?: string, configuration?: SuperRooSettings, images?: string[]): Promise<void>
...
export class ExtensionHost extends EventEmitter implements ExtensionHostInterface {
	...
	private initialSettings: SuperRooSettings
	...
	constructor(options: ExtensionHostOptions) {
		...
		const baseSettings: SuperRooSettings = {
	...
	public markWebviewReady(): void {
		...
		setRuntimeConfigValues("superroo", this.initialSettings as Record<string, unknown>)
