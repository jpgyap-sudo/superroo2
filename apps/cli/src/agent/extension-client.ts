...
import type { ExtensionMessage, WebviewMessage, ClineAskResponse, ClineMessage, ClineAsk } from "@superroo/types"
...
/**
 * ExtensionClient is the main interface for interacting with the SuperRoo extension.
 *
 * Basic usage:
 * ```typescript
