...
export type SuperRooCloudModel = z.infer<typeof rooCodeCloudModelSchema>

export const getSuperRooCloudModels = async (): Promise<SuperRooCloudModel[]> => {
	const response = await fetch("https://api.superroo.com/proxy/v1/models")
...
export const useSuperRooCloudModels = () => {
	const query = useQuery({
		queryKey: ["getSuperRooCloudModels"],
		queryFn: getSuperRooCloudModels,
	})
