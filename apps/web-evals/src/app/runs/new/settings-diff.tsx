import { type Keys, type SuperRooSettings, GLOBAL_SETTINGS_KEYS, PROVIDER_SETTINGS_KEYS } from "@superroo/types"

import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui"

export const SUPERROO_SETTINGS_KEYS = [
	...new Set([...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS]),
] as Keys<SuperRooSettings>[]

type SettingsDiffProps = {
	defaultSettings: SuperRooSettings
	customSettings: SuperRooSettings
}
	...
	return (
		<div className="border rounded-sm">
			<Table>
				...
				<TableBody>
					{SUPERROO_SETTINGS_KEYS.map((key) => {
