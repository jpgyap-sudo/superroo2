			...
			<div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
				...
				<div className="space-y-6">
					...
					<Card className="border-[#1e2535] bg-gradient-to-b from-[#0f1117] to-[#0a0e1a]">
								...
								return (
									<button
										...
										<div className="flex items-center gap-2 text-sm text-slate-300">
											...
											<Pill type={rule.enabled ? "connected" : "neutral"}>{rule.enabled ? "On" : "Off"}</Pill>
											</button>
									))
								}
							</div>
						...
						{/* Current Coding Task */}
						<Card className="border-[#1e2535] bg-gradient-to-b from-[#0f1117] to-[#0a0e1a]">
							<CardHeader icon={GitBranch} title="Current Coding Task" subtitle="Sandbox branch generated by Telegram." />
							<div className="space-y-4 p-5">
