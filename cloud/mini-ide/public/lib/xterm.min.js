		...
		var e = {
				...
				6465: function (e, t, i) {
					...
					let c = (t.Linkifier2 = class extends a.Disposable {
						...
						_checkLinkProviderResult(e, t, i) {
							...
							let n = !1
							for (let t = 0; t < e; t++)
								(this._activeProviderReplies.has(t) && !this._activeProviderReplies.get(t)) || (n = !0)
							if (!n && r) {
								...
								this._renderService &&
									this._linkCacheDisposables.push(
										this._renderService.onRenderedViewportChange((e) => {
											...
											const t =
													0 === e.start ? 0 : e.start + 1 + this._bufferService.buffer.ydisp,
										...
										if (s) {
											...
											n ||
												r.push({
													...
													hover: (e, t) => {
														var s
														return null === (s = null == o ? void 0 : o.hover) ||
															void 0 === s
															? void 0
															: s.call(o, e, t, i)
													},
													leave: (e, t) => {
														var s
														return null === (s = null == o ? void 0 : o.leave) ||
															void 0 === s
															? void 0
															: s.call(o, e, t, i)
													},
					...
					class P extends y.CoreTerminal {
						...
						constructor(e = {}) {
							super(e),
								...
								this._instantiationService.setService(B.IDecorationService, this._decorationService),
								this.register(this._inputHandler.onRequestBell(() => this._onBell.fire())),
								this.register(this._inputHandler.onRequestRefreshRows((e, t) => this.refresh(e, t))),
								...
								this.register((0, w.forwardEvent)(this._inputHandler.onCursorMove, this._onCursorMove)),
								this.register(
								...
								k.isLinux &&
									this.register(
										(0, r.addDisposableDomListener)(this.element, "auxclick", (e) => {
											1 === e.button &&
												(0, s.moveTextAreaUnderMouseCursor)(
													e,
													this.textarea,
													this.screenElement,
												)
						...
						open(e) {
							...
							;(this._viewportElement = O.createElement("div")),
								...
								this._instantiationService.setService(S.ICoreBrowserService, this._coreBrowserService),
								this.register(
									...
									e
										...
										8 & e
											? s.mousemove ||
												...
												(s.mousemove = n.mousemove))
											: (t.removeEventListener("mousemove", s.mousemove), (s.mousemove = null)),
										16 & e
											? s.wheel ||
												(t.addEventListener("wheel", n.wheel, { passive: !1 }),
												(s.wheel = n.wheel))
				...
				1680: function (e, t, i) {
					...
					let l = (t.Viewport = class extends h.Disposable {
						...
						syncScrollArea(e = !1) {
							...
							;(this._lastRecordedViewportHeight === this._renderService.dimensions.css.canvas.height &&
					...
					let c = (t.BufferDecorationRenderer = class extends a.Disposable {
						...
						_refreshXPosition(e, t = e.element) {
							...
							"right" === (e.options.anchor || "left")
								? (t.style.right = s ? s * this._renderService.dimensions.css.cell.width + "px" : "")
				...
				2950: function (e, t, i) {
					...
					t.CompositionHelper = h = s(
						[r(2, o.IBufferService), r(3, o.IOptionsService), r(4, o.ICoreService), r(5, n.IRenderService)],
						h,
					)
				},
				9806: (e, t) => {
				...
				9504: (e, t, i) => {
					...
					function a(e, t, i, s, r, n) {
						...
						for (; o !== i || a !== s; )
							(o += r ? 1 : -1),
								r && o > n.cols - 1
									? ((h += n.buffer.translateBufferLineToString(a, !1, e, o)), (o = 0), (e = 0), a++)
									: !r &&
										o < 0 &&
					...
					class c {
						...
						measure() {
							...
							return (
								0 !== e.width &&
									0 !== e.height &&
									((this._result.width = e.width / 32), (this._result.height = Math.ceil(e.height))),
								this._result
							)
						}
					}
				...
				9312: function (e, t, i) {
					...
					let g = (t.SelectionService = class extends l.Disposable {
						...
						shouldColumnSelect(e) {
							return (
								e.altKey && !(d.isMac && this._optionsService.rawOptions.macOptionClickForcesSelection)
							)
						}
						_handleMouseMove(e) {
						...
						_selectLineAt(e) {
							...
							;(this._model.selectionStart = [0, t.first]),
								(this._model.selectionEnd = void 0),
								(this._model.selectionStartLength = (0, _.getRangeLength)(i, this._bufferService.cols))
						}
					})
					...
					class n extends r.Disposable {
						...
						splice(e, t, ...i) {
							...
							for (let t = this._length - 1; t >= e; t--)
								this._array[this._getCyclicIndex(t + i.length)] = this._array[this._getCyclicIndex(t)]
					...
					class S extends s.Disposable {
						...
						constructor(e) {
							super(),
								...
								(this._charsetService = this._instantiationService.createInstance(u.CharsetService)),
								this._instantiationService.setService(r.ICharsetService, this._charsetService),
								(this._oscLinkService = this._instantiationService.createInstance(g.OscLinkService)),
								...
								this.register((0, l.forwardEvent)(this._writeBuffer.onWriteParsed, this._onWriteParsed))
						}
						write(e, t) {
						...
						writeSync(e, t) {
							this._logService.logLevel <= r.LogLevelEnum.WARN &&
								!m &&
								(this._logService.warn("writeSync is unreliable and will be removed soon."), (m = !0)),
					...
					class E extends h.Disposable {
						...
						constructor(e, t, i, s, r, h, _, f, v = new a.EscapeSequenceParser()) {
							super(),
								...
								this._parser.registerOscHandler(110, new p.OscHandler((e) => this.restoreFgColor(e))),
								this._parser.registerOscHandler(111, new p.OscHandler((e) => this.restoreBgColor(e))),
								this._parser.registerOscHandler(
									112,
						...
						requestStatusString(e, t) {
							...
							return ((e) => (this._coreService.triggerDataEvent(`${n.C0.ESC}${e}${n.C0.ESC}\\`), !0))(
								'"q' === e
						...
						(t.Buffer = class {
							...
							_reflowSmaller(e, t) {
								...
								for (let n = this.lines.length - 1; n >= 0; n--) {
									...
									v.length > 0 && (s.push({ start: n + c.length + r, newLines: v }), (r += v.length)),
										c.push(...v)
									let p = _.length - 1,
										g = _[p]
									0 === g && (p--, (g = _[p]))
				...
				8437: (e, t, i) => {
					...
					class h {
						constructor(e, t, i = !1) {
							...
							const s =
								t || r.CellData.fromCharData([0, n.NULL_CELL_CHAR, n.NULL_CELL_WIDTH, n.NULL_CELL_CODE])
									...
									if ((i && !n) || !e.altKey || e.metaKey)
										!i || e.altKey || e.ctrlKey || e.shiftKey || !e.metaKey
											? e.key &&
												...
												: e.key &&
													e.ctrlKey &&
													("_" === e.key && (o.key = s.C0.US),
													"@" === e.key && (o.key = s.C0.NUL))
						...
						(t.DcsHandler = class {
							...
							put(e, t, i) {
								this._hitLimit ||
									...
									this._data.length > n.PAYLOAD_LIMIT && ((this._data = ""), (this._hitLimit = !0)))
							}
							unhook(e) {
								let t = !1
											...
											if (!1 === i && n > -1)
												for (; n >= 0 && ((s = t[n](this._params)), !0 !== s); n--)
													if (s instanceof Promise)
														return (this._parseStack.handlerPos = n), s
						...
						(t.OscHandler = class {
							...
							put(e, t, i) {
								this._hitLimit ||
									...
									this._data.length > s.PAYLOAD_LIMIT && ((this._data = ""), (this._hitLimit = !0)))
							}
							end(e) {
								let t = !1
								if (this._hitLimit) t = !1
					...
					t.BufferLineApiView = class {
						...
						getCell(e, t) {
							if (!(e < 0 || e >= this._line.length))
								return t ? (this._line.loadCell(e, t), t) : this._line.loadCell(e, new s.CellData())
						}
