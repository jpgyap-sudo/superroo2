 ...
 *
 * This class manages the state for the marketplace view in the SuperRoo extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the SuperRoo extensions interface
...
import { MarketplaceItem, MarketplaceInstalledMetadata } from "@superroo/types"
