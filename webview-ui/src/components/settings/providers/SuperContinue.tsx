...
import type { ProviderSettings, ExtensionMessage, ModelRecord } from "@superroo/types"
...
type SuperContinueProps = {
	apiConfiguration: ProviderSettings
	setApiConfigurationField: (field: keyof ProviderSettings, value: ProviderSettings[keyof ProviderSettings]) => void
}

export const SuperContinue = ({ apiConfiguration, setApiConfigurationField }: SuperContinueProps) => {
	...
	return (
		<>
			...
			<div className="text-sm text-vscode-descriptionForeground">
				{t("settings:providers.supercontinue.description")}
				<span className="text-vscode-errorForeground ml-1">{t("settings:providers.supercontinue.warning")}</span>
			</div>
		</>
	)
}