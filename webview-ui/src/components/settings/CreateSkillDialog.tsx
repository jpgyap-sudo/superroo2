...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@superroo/types"
...
/**
 * Validate skill name using shared validation from @superroo/types.
