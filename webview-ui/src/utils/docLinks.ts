/**
 * Utility for building SuperRoo documentation links with UTM telemetry.
 *
...
export function buildDocLink(path: string, campaign: string): string {
	...
	const baseUrl = `https://docs.superroo.com/${basePath}?utm_source=extension&utm_medium=ide&utm_campaign=${encodeURIComponent(campaign)}`
