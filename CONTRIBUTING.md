...
SuperRoo is a community-driven project, and we deeply value every contribution. To streamline collaboration, we operate on an [Issue-First](#issue-first-approach) basis, meaning all [Pull Requests (PRs)](#submitting-a-pull-request) must first be linked to a GitHub Issue. Please review this guide carefully.
...
### 3. Join the SuperRoo Community

- **Primary:** Join our [Discord](https://discord.gg/superroo) and DM **Hannes Rudolph (`hrudolph`)**.
- **Alternative:** Experienced contributors can engage directly via [GitHub Projects](https://github.com/orgs/SuperRooInc/projects/1).
...
- **Check existing issues**: Search [GitHub Issues](https://github.com/SuperRooInc/SuperRoo/issues).
...
- **Want to work on it?** Comment "Claiming" on the issue and DM **Hannes Rudolph (`hrudolph`)** on [Discord](https://discord.gg/superroo) to get assigned. Assignment will be confirmed in the thread.
- **PRs must link to the issue.** Unlinked PRs may be closed.

### Deciding What to Work On

- Check the [GitHub Project](https://github.com/orgs/SuperRooInc/projects/1) for "Issue [Unassigned]" issues.
- For docs, visit [SuperRoo Docs](https://github.com/SuperRooInc/SuperRoo-Docs).

### Reporting Bugs

- Check for existing reports first.
- Create a new bug using the ["Bug Report" template](https://github.com/SuperRooInc/SuperRoo/issues/new/choose) with:
    - Clear, numbered reproduction steps
    - Expected vs actual result
    - SuperRoo version (required); API provider/model if relevant
- **Security issues**: Report privately via [security advisories](https://github.com/SuperRooInc/SuperRoo/security/advisories/new).
...
```
git clone https://github.com/YOUR_USERNAME/SuperRoo.git
```
...
- Must reference an assigned GitHub Issue. To get assigned: comment "Claiming" on the issue and DM **Hannes Rudolph (`hrudolph`)** on [Discord](https://discord.gg/superroo). Assignment will be confirmed in the thread.
...
By contributing, you agree your contributions will be licensed under the Apache 2.0 License, consistent with SuperRoo's licensing.
