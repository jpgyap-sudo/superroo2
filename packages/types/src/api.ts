...
import type { SuperRooEvents } from "./events.js"
...
export type SuperRooAPIEvents = SuperRooEvents

export interface SuperRooAPI extends EventEmitter<SuperRooAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): SuperRooSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: SuperRooSettings): Promise<void>
	/**
...
export interface SuperRooIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
