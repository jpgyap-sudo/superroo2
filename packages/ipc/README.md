...
This package provides IPC functionality for SuperRoo, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: SuperRoo settings object
...
- Unix/Linux/macOS: `/tmp/superroo-{id}.sock`
- Windows: `\\.\pipe\superroo-{id}`
