...
import { type AuthService, type ShareVisibility, type ShareResponse, shareResponseSchema } from "@superroo/types"

import { getSuperRooApiUrl } from "./config.js"
...
export class CloudAPI {
	...
	constructor(authService: AuthService, log?: (...args: unknown[]) => void) {
		...
		this.baseUrl = getSuperRooApiUrl()
	}
