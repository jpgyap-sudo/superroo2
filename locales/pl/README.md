...
<p align="center">
  <em>Uzyskaj szybką pomoc → <a href="https://discord.gg/superroo">Dołącz do Discorda</a> • Wolisz asynchronicznie? → <a href="https://www.reddit.com/r/SuperRoo/">Dołącz do r/SuperRoo</a></em>
</p>
...
> ### Wtyczka SuperRoo nie znika.
>
> Być może widziałeś [niedawne ogłoszenie](https://x.com/mattrubens/status/2046636598859559114), że SuperRoo osiągnął 3 miliony instalacji, a oryginalny zespół całkowicie skupia się na Roomote. Wiemy, że ta wiadomość była trudna dla wielu z was. Ta wtyczka wiele dla nas i dla ciebie znaczy, i słyszymy was.
>
> Dobra wiadomość: **zespół społeczności zgłosił się, żeby poprowadzić SuperRoo dalej**, i pracujemy z nimi nad oficjalnym przekazaniem, żeby wtyczka, na której polegasz, była nadal utrzymywana i ulepszana.
...
## Co SuperRoo może zrobić dla CIEBIE?
...
SuperRoo dostosowuje się do Twojego sposobu pracy, a nie odwrotnie:
...
Więcej: [Korzystanie z trybów](https://docs.superroo.com/basic-usage/using-modes) • [Tryby niestandardowe](https://docs.superroo.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.superroo.com/tutorial-videos">Więcej szybkich filmów instruktażowych i prezentujących funkcje...</a>
</p>

## Zasoby

- **[Dokumentacja](https://docs.superroo.com):** Oficjalny przewodnik po instalacji, konfiguracji i opanowaniu SuperRoo.
- **[Kanał YouTube](https://youtube.com/@superrooyt?feature=shared):** Oglądaj samouczki i zobacz funkcje w akcji.
- **[Serwer Discord](https://discord.gg/superroo):** Dołącz do społeczności, aby uzyskać pomoc i dyskutować w czasie rzeczywistym.
- **[Społeczność Reddit](https://www.reddit.com/r/SuperRoo):** Dziel się swoimi doświadczeniami i zobacz, co budują inni.
- **[Problemy na GitHub](https://github.com/SuperRooInc/SuperRoo/issues):** Zgłaszaj błędy i śledź rozwój.
- **[Prośby o funkcje](https://github.com/SuperRooInc/SuperRoo/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Masz pomysł? Podziel się nim z deweloperami.
...
Istnieje kilka sposobów na uruchomienie rozszerzenia SuperRoo:

### Tryb deweloperski (F5)

Do aktywnego programowania użyj wbudowanego debugowania VSCode:

Naciśnij `F5` (lub przejdź do **Uruchom** → **Rozpocznij debugowanie**) w VSCode. Otworzy to nowe okno VSCode z uruchomionym rozszerzeniem SuperRoo.
...
1.  Najpierw zbuduj pakiet VSIX:
    ...
    pnpm vsix
    ```
2.  Plik `.vsix` zostanie wygenerowany w katalogu `bin/` (np. `bin/superroo-<version>.vsix`).
...
**Miłej zabawy z SuperRoo!** Trzymaj go na krótkiej smyczy albo pozwól działać autonomicznie — nie możemy się doczekać, co zbudujesz. Masz pytania lub pomysły na funkcje? Wpadnij na naszą [społeczność Reddit](https://www.reddit.com/r/SuperRoo/) lub [Discord](https://discord.gg/superroo). Miłego kodowania!
