...
<p align="center">
  <em>Nhận trợ giúp nhanh → <a href="https://discord.gg/superroo">Tham gia Discord</a> • Thích không đồng bộ? → <a href="https://www.reddit.com/r/SuperRoo/">Tham gia r/SuperRoo</a></em>
</p>
...
> ### Plugin SuperRoo sẽ không biến mất.
>
> Bạn có thể đã thấy [thông báo gần đây](https://x.com/mattrubens/status/2046636598859559114) rằng SuperRoo đã đạt 3 triệu lượt cài đặt và đội ngũ ban đầu đang dồn toàn lực cho Roomote. Chúng tôi biết rằng tin này thật khó khăn với nhiều bạn. Plugin này có ý nghĩa rất lớn với chúng tôi và với bạn, và chúng tôi lắng nghe bạn.
>
> Tin tốt: **một đội ngũ từ cộng đồng đã đứng ra tiếp tục đưa SuperRoo đi tiếp**, và chúng tôi đang làm việc với họ về việc bàn giao chính thức để plugin mà bạn đang tin cậy tiếp tục được bảo trì và cải thiện.
...
## SuperRoo có thể làm gì cho BẠN?
...
SuperRoo thích ứng với cách bạn làm việc, chứ không phải ngược lại:
...
Xem thêm: [Sử dụng Chế độ](https://docs.superroo.com/basic-usage/using-modes) • [Chế độ tùy chỉnh](https://docs.superroo.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.superroo.com/tutorial-videos">Thêm video hướng dẫn và tính năng nhanh...</a>
</p>

## Tài nguyên

- **[Tài liệu](https://docs.superroo.com):** Hướng dẫn chính thức để cài đặt, cấu hình và sử dụng thành thạo SuperRoo.
- **[Kênh YouTube](https://youtube.com/@superrooyt?feature=shared):** Xem các video hướng dẫn và các tính năng đang hoạt động.
- **[Máy chủ Discord](https://discord.gg/superroo):** Tham gia cộng đồng để được trợ giúp và thảo luận trong thời gian thực.
- **[Cộng đồng Reddit](https://www.reddit.com/r/SuperRoo):** Chia sẻ kinh nghiệm của bạn và xem những người khác đang xây dựng gì.
- **[Vấn đề trên GitHub](https://github.com/SuperRooInc/SuperRoo/issues):** Báo cáo lỗi và theo dõi quá trình phát triển.
- **[Yêu cầu tính năng](https://github.com/SuperRooInc/SuperRoo/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Có ý tưởng? Hãy chia sẻ với các nhà phát triển.
...
Có một số cách để chạy phần mở rộng SuperRoo:

### Chế độ phát triển (F5)

Để phát triển tích cực, hãy sử dụng tính năng gỡ lỗi tích hợp của VSCode:

Nhấn `F5` (hoặc vào **Run** → **Start Debugging**) trong VSCode. Thao tác này sẽ mở một cửa sổ VSCode mới với phần mở rộng SuperRoo đang chạy.
...
1.  Đầu tiên, hãy xây dựng gói VSIX:
    ...
    pnpm vsix
    ```
2.  Một tệp `.vsix` sẽ được tạo trong thư mục `bin/` (ví dụ: `bin/superroo-<version>.vsix`).
...
**Thưởng thức SuperRoo!** Dù bạn giữ nó trong tầm kiểm soát chặt chẽ hay để nó tự do hoạt động, chúng tôi rất nóng lòng muốn xem bạn sẽ xây dựng được gì. Nếu bạn có câu hỏi hoặc ý tưởng về tính năng, hãy ghé qua [cộng đồng Reddit](https://www.reddit.com/r/SuperRoo/) hoặc [Discord](https://discord.gg/superroo) của chúng tôi. Chúc bạn viết mã vui vẻ!
