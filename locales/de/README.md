...
<p align="center">
  <em>Schnelle Hilfe → <a href="https://discord.gg/superroo">Discord beitreten</a> • Lieber asynchron? → <a href="https://www.reddit.com/r/SuperRoo/">r/SuperRoo beitreten</a></em>
</p>
...
> ### Das SuperRoo-Plugin verschwindet nicht.
>
> Du hast vielleicht die [neuliche Ankündigung](https://x.com/mattrubens/status/2046636598859559114) gesehen, dass SuperRoo 3 Millionen Installationen erreicht hat und das ursprüngliche Team sich voll auf Roomote konzentriert. Wir wissen, dass diese Nachricht für viele von euch schwer war. Dieses Plugin bedeutet uns und dir sehr viel, und wir hören dich.
>
> Die gute Nachricht: **ein Community-Team hat sich bereit erklärt, SuperRoo weiterzuführen**, und wir arbeiten mit ihnen an einer offiziellen Übergabe, damit das Plugin, auf das du dich verlässt, weiterhin gepflegt und verbessert wird.
...
## Was kann SuperRoo für DICH tun?
...
SuperRoo passt sich an deine Arbeitsweise an, nicht umgekehrt:
...
Mehr erfahren: [Modi verwenden](https://docs.superroo.com/basic-usage/using-modes) • [Benutzerdefinierte Modi](https://docs.superroo.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.superroo.com/tutorial-videos">Weitere schnelle Tutorial- und Feature-Videos...</a>
</p>

## Ressourcen

- **[Dokumentation](https://docs.superroo.com):** Die offizielle Anleitung zur Installation, Konfiguration und Beherrschung von SuperRoo.
- **[YouTube-Kanal](https://youtube.com/@superrooyt?feature=shared):** Schau dir Tutorials an und sieh Features in Aktion.
- **[Discord-Server](https://discord.gg/superroo):** Tritt der Community bei für Echtzeit-Hilfe und Diskussionen.
- **[Reddit-Community](https://www.reddit.com/r/SuperRoo):** Teile deine Erfahrungen und sieh, was andere bauen.
- **[GitHub Issues](https://github.com/SuperRooInc/SuperRoo/issues):** Melde Fehler und verfolge die Entwicklung.
- **[Feature-Anfragen](https://github.com/SuperRooInc/SuperRoo/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Hast du eine Idee? Teile sie mit den Entwicklern.
...
Es gibt mehrere Möglichkeiten, die SuperRoo-Erweiterung auszuführen:

### Entwicklungsmodus (F5)

Für die aktive Entwicklung verwende das integrierte Debugging von VSCode:

Drücke `F5` (oder gehe zu **Ausführen** → **Debuggen starten**) in VSCode. Dies öffnet ein neues VSCode-Fenster mit der laufenden SuperRoo-Erweiterung.
...
1.  Erstelle zuerst das VSIX-Paket:
    ...
    pnpm vsix
    ```
2.  Eine `.vsix`-Datei wird im `bin/`-Verzeichnis generiert (z. B. `bin/superroo-<version>.vsix`).
