...
<p align="center">
  <em>Obtenez de l'aide rapidement → <a href="https://discord.gg/superroo">Rejoignez Discord</a> • Vous préférez l'asynchrone ? → <a href="https://www.reddit.com/r/SuperRoo/">Rejoignez r/SuperRoo</a></em>
</p>
...
> ### L'extension SuperRoo ne va pas disparaître.
>
> Tu as peut-être vu l'[annonce récente](https://x.com/mattrubens/status/2046636598859559114) : SuperRoo a franchi les 3 millions d'installations et l'équipe d'origine se consacre désormais entièrement à Roomote. On sait que cette nouvelle a été difficile pour beaucoup d'entre vous. Cette extension compte énormément pour nous comme pour toi, et on t'entend.
>
> La bonne nouvelle : **une équipe de la communauté a décidé de prendre le relais pour faire avancer SuperRoo**, et on travaille avec eux sur une transmission officielle pour que l'extension sur laquelle tu comptes continue d'être maintenue et améliorée.
...
## Que peut faire SuperRoo pour VOUS ?
...
SuperRoo s'adapte à votre façon de travailler, pas l'inverse :
...
En savoir plus : [Utiliser les Modes](https://docs.superroo.com/basic-usage/using-modes) • [Modes personnalisés](https://docs.superroo.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.superroo.com/tutorial-videos">Plus de tutoriels rapides et de vidéos de fonctionnalités...</a>
</p>

## Ressources

- **[Documentation](https://docs.superroo.com):** Le guide officiel pour installer, configurer et maîtriser SuperRoo.
- **[Chaîne YouTube](https://youtube.com/@superrooyt?feature=shared):** Regardez des tutoriels et découvrez les fonctionnalités en action.
- **[Serveur Discord](https://discord.gg/superroo):** Rejoignez la communauté pour obtenir de l'aide en temps réel et discuter.
- **[Communauté Reddit](https://www.reddit.com/r/SuperRoo):** Partagez vos expériences et découvrez ce que les autres construisent.
- **[Problèmes GitHub](https://github.com/SuperRooInc/SuperRoo/issues):** Signalez des bugs et suivez le développement.
- **[Demandes de fonctionnalités](https://github.com/SuperRooInc/SuperRoo/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Vous avez une idée ? Partagez-la avec les développeurs.
...
Il existe plusieurs façons d'exécuter l'extension SuperRoo :

### Mode développement (F5)

Pour un développement actif, utilisez le débogage intégré de VSCode :

Appuyez sur `F5` (ou allez dans **Exécuter** → **Démarrer le débogage**) dans VSCode. Cela ouvrira une nouvelle fenêtre VSCode avec l'extension SuperRoo en cours d'exécution.
...
1.  D'abord, compilez le package VSIX :
    ...
    pnpm vsix
    ```
2.  Un fichier `.vsix` sera généré dans le répertoire `bin/` (par exemple, `bin/superroo-<version>.vsix`).
