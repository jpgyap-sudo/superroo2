...
# SuperRoo'a Katkıda Bulunma

SuperRoo topluluk tarafından yürütülen bir projedir ve her katkıyı derinden takdir ediyoruz. İşbirliğini kolaylaştırmak için [Önce Sorun Yaklaşımı](#önce-sorun-yaklaşımı) temelinde çalışıyoruz, bu da tüm [Çekme İsteklerinin (PR'ler)](#bir-çekme-isteği-gönderme) önce bir GitHub Sorununa bağlanması gerektiği anlamına gelir. Lütfen bu kılavuzu dikkatlice inceleyin.
...
### 3. SuperRoo Topluluğuna Katılın

- **Birincil:** [Discord](https://discord.gg/superroo) sunucumuza katılın ve **Hannes Rudolph (`hrudolph`)**'a DM gönderin.
- **Alternatif:** Deneyimli katkıda bulunanlar doğrudan [GitHub Projeleri](https://github.com/orgs/SuperRooInc/projects/1) aracılığıyla etkileşimde bulunabilirler.
...
- **Mevcut sorunları kontrol edin**: [GitHub Sorunları](https://github.com/SuperRooInc/SuperRoo/issues)nda arama yapın.
- **Bir sorun oluşturun**:
...
- **Üzerinde çalışmak ister misiniz?** Soruna "Talep ediyorum" yorumu yapın ve atanmak için [Discord](https://discord.gg/superroo) üzerinden **Hannes Rudolph (`hrudolph`)**'a DM gönderin. Atama, başlıkta teyit edilecektir.
- **PR'ler soruna bağlanmalıdır.** Bağlantısız PR'ler kapatılabilir.

### Ne Üzerinde Çalışılacağına Karar Verme

- "Sorun [Atanmamış]" sorunları için [GitHub Projesi](https://github.com/orgs/SuperRooInc/projects/1)'ni kontrol edin.
- Belgeler için [SuperRoo Belgeleri](https://github.com/SuperRooInc/SuperRoo-Docs)ni ziyaret edin.

### Hataları Bildirme

- Önce mevcut raporları kontrol edin.
- Aşağıdakilerle ["Hata Raporu" şablonunu](https://github.com/SuperRooInc/SuperRoo/issues/new/choose) kullanarak yeni bir hata oluşturun:
    - Açık, numaralandırılmış yeniden oluşturma adımları
    - Beklenen vs gerçek sonuç
    - SuperRoo sürümü (gerekli); ilgiliyse API sağlayıcısı/modeli
- **Güvenlik sorunları**: [Güvenlik tavsiyeleri](https://github.com/SuperRooInc/SuperRoo/security/advisories/new) aracılığıyla özel olarak bildirin.
...
```
git clone https://github.com/KULLANICI_ADINIZ/SuperRoo.git
```
...
- Atanmış bir GitHub Sorununa atıfta bulunmalıdır. Atanmak için: soruna "Talep ediyorum" yorumu yapın ve [Discord](https://discord.gg/superroo) üzerinden **Hannes Rudolph (`hrudolph`)**'a DM gönderin. Atama, başlıkta teyit edilecektir.
...
Katkıda bulunarak, katkılarınızın SuperRoo'un lisanslamasıyla tutarlı olan Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursunuz.
