...
<p align="center">
  <em>Hızlı yardım alın → <a href="https://discord.gg/superroo">Discord'a Katılın</a> • Asenkron mu tercih edersiniz? → <a href="https://www.reddit.com/r/SuperRoo/">r/SuperRoo'a Katılın</a></em>
</p>
...
> ### SuperRoo eklentisi bir yere gitmiyor.
>
> SuperRoo'un 3 milyon kuruluma ulaştığı ve orijinal ekibin tüm enerjisini Roomote'a verdiği [son duyuruyu](https://x.com/mattrubens/status/2046636598859559114) görmüş olabilirsin. Bu haberin birçoğunuz için zor olduğunu biliyoruz. Bu eklenti bizim ve senin için çok şey ifade ediyor ve seni duyuyoruz.
>
> İyi haber: **bir topluluk ekibi SuperRoo'u ileriye taşımak için öne çıktı**, ve güvendiğin eklentinin bakımı ve geliştirilmesinin sürmesi için onlarla resmi bir devir çalışması yürütüyoruz.
...
## SuperRoo SİZİN İçin Ne Yapabilir?
...
SuperRoo, sizin çalışma şeklinize uyum sağlar, tam tersi değil:
...
Daha fazla: [Modları kullanma](https://docs.superroo.com/basic-usage/using-modes) • [Özel modlar](https://docs.superroo.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.superroo.com/tutorial-videos">Daha fazla hızlı eğitim ve özellik videosu...</a>
</p>

## Kaynaklar

- **[Dokümantasyon](https://docs.superroo.com):** SuperRoo'u yükleme, yapılandırma ve ustalaşma konusundaki resmi kılavuz.
- **[YouTube Kanalı](https://youtube.com/@superrooyt?feature=shared):** Eğitimleri izleyin ve özellikleri çalışırken görün.
- **[Discord Sunucusu](https://discord.gg/superroo):** Gerçek zamanlı yardım ve tartışma için topluluğa katılın.
- **[Reddit Topluluğu](https://www.reddit.com/r/SuperRoo):** Deneyimlerinizi paylaşın ve başkalarının ne inşa ettiğini görün.
- **[GitHub Sorunları](https://github.com/SuperRooInc/SuperRoo/issues):** Hataları bildirin ve gelişimi takip edin.
- **[Özellik İstekleri](https://github.com/SuperRooInc/SuperRoo/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Bir fikriniz mi var? Geliştiricilerle paylaşın.
...
SuperRoo uzantısını çalıştırmanın birkaç yolu vardır:

### Geliştirme Modu (F5)

Aktif geliştirme için VSCode'un yerleşik hata ayıklama özelliğini kullanın:

VSCode'da `F5` tuşuna basın (veya **Çalıştır** → **Hata Ayıklamayı Başlat**'a gidin). Bu, SuperRoo uzantısının çalıştığı yeni bir VSCode penceresi açacaktır.
...
1.  İlk olarak, VSIX paketini oluşturun:
    ...
    pnpm vsix
    ```
2.  `bin/` dizininde bir `.vsix` dosyası oluşturulur (ör. `bin/superroo-<version>.vsix`).
...
**SuperRoo'un keyfini çıkar!** Onu kısa tasmalı tut ya da otonom dolaşsın; ne inşa edeceğini görmek için sabırsızlanıyoruz. Soruların veya özellik fikirlerin varsa [Reddit topluluğumuza](https://www.reddit.com/r/SuperRoo/) ya da [Discord](https://discord.gg/superroo)'a uğra. İyi kodlamalar!
