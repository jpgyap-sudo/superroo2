...
<p align="center">
  <em>Snel hulp krijgen → <a href="https://discord.gg/superroo">Word lid van Discord</a> • Liever asynchroon? → <a href="https://www.reddit.com/r/SuperRoo/">Word lid van r/SuperRoo</a></em>
</p>
...
> ### De SuperRoo-plugin gaat niet weg.
>
> Je hebt misschien de [recente aankondiging](https://x.com/mattrubens/status/2046636598859559114) gezien dat SuperRoo 3 miljoen installaties heeft bereikt en het oorspronkelijke team zich volledig richt op Roomote. We weten dat dat nieuws voor velen van jullie moeilijk was. Deze plugin betekent veel voor ons en voor jou, en we horen je.
>
> Het goede nieuws: **een community-team heeft zich aangemeld om SuperRoo voort te zetten**, en we werken samen aan een officiële overdracht, zodat de plugin waar je op vertrouwt onderhouden en verbeterd blijft worden.
...
## Wat kan SuperRoo voor JOU doen?
...
SuperRoo past zich aan jouw werkwijze aan, niet andersom:
...
Meer info: [Modi gebruiken](https://docs.superroo.com/basic-usage/using-modes) • [Aangepaste modi](https://docs.superroo.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.superroo.com/tutorial-videos">Meer snelle tutorial- en featurevideo's...</a>
</p>

## Hulpbronnen

- **[Documentatie](https://docs.superroo.com):** De officiële gids voor het installeren, configureren en beheersen van SuperRoo.
- **[YouTube-kanaal](https://youtube.com/@superrooyt?feature=shared):** Bekijk tutorials en zie functies in actie.
- **[Discord Server](https://discord.gg/superroo):** Word lid van de community voor realtime hulp en discussie.
- **[Reddit Community](https://www.reddit.com/r/SuperRoo):** Deel je ervaringen en kijk wat anderen bouwen.
- **[GitHub Issues](https://github.com/SuperRooInc/SuperRoo/issues):** Meld bugs en volg de ontwikkeling.
- **[Feature Requests](https://github.com/SuperRooInc/SuperRoo/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Heb je een idee? Deel het met de ontwikkelaars.
...
Er zijn verschillende manieren om de SuperRoo-extensie uit te voeren:

### Ontwikkelmodus (F5)

Gebruik voor actieve ontwikkeling de ingebouwde foutopsporing van VSCode:

Druk op `F5` (of ga naar **Uitvoeren** → **Foutopsporing starten**) in VSCode. Dit opent een nieuw VSCode-venster waarin de SuperRoo-extensie wordt uitgevoerd.
...
1.  Bouw eerst het VSIX-pakket:
    ...
    pnpm vsix
    ```
2.  Een `.vsix`-bestand wordt gegenereerd in de `bin/`-directory (bijv. `bin/superroo-<version>.vsix`).
...
**Veel plezier met SuperRoo!** Of je het nu strak aan de lijn houdt of autonoom laat rondlopen, we zijn benieuwd wat je bouwt. Vragen of feature-ideeën? Kom langs op onze [Reddit-community](https://www.reddit.com/r/SuperRoo/) of [Discord](https://discord.gg/superroo). Happy coding!
