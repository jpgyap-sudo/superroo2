...
# Bijdragen aan SuperRoo

SuperRoo is een door de gemeenschap gedreven project en we waarderen elke bijdrage ten zeerste. Om de samenwerking te stroomlijnen, werken we op basis van een [Issue-First-aanpak](#issue-first-aanpak), wat betekent dat alle [Pull Requests (PR's)](#een-pull-request-indienen) eerst gekoppeld moeten zijn aan een GitHub Issue. Lees deze handleiding zorgvuldig door.
...
### 3. Word lid van de SuperRoo-community

- **Primair:** Word lid van onze [Discord](https://discord.gg/superroo) en stuur een DM naar **Hannes Rudolph (`hrudolph`)**.
- **Alternatief:** Ervaren bijdragers kunnen rechtstreeks deelnemen via [GitHub Projects](https://github.com/orgs/SuperRooInc/projects/1).
...
- **Controleer bestaande issues**: Zoek in [GitHub Issues](https://github.com/SuperRooInc/SuperRoo/issues).
...
- **Wil je eraan werken?** Reageer met "Claiming" op de issue en stuur een DM naar **Hannes Rudolph (`hrudolph`)** op [Discord](https://discord.gg/superroo) om toegewezen te worden. De toewijzing wordt in de thread bevestigd.
- **PR's moeten naar de issue linken.** Niet-gekoppelde PR's kunnen worden gesloten.

### Beslissen waaraan je wilt werken

- Controleer het [GitHub Project](https://github.com/orgs/SuperRooInc/projects/1) voor "Issue [Niet-toegewezen]" issues.
- Ga voor documentatie naar [SuperRoo Docs](https://github.com/SuperRooInc/SuperRoo-Docs).

### Bugs rapporteren

- Controleer eerst bestaande rapporten.
- Maak een nieuwe bug aan met het ["Bugrapport"-sjabloon](https://github.com/SuperRooInc/SuperRoo/issues/new/choose) met:
    - Duidelijke, genummerde reproductiestappen
    - Verwacht vs. feitelijk resultaat
    - SuperRoo-versie (vereist); API-provider/model indien relevant
- **Beveiligingsproblemen**: Rapporteer privé via [beveiligingsadviezen](https://github.com/SuperRooInc/SuperRoo/security/advisories/new).
...
```
git clone https://github.com/JOUW_GEBRUIKERSNAAM/SuperRoo.git
```
...
- Moet verwijzen naar een toegewezen GitHub Issue. Om toegewezen te worden: reageer met "Claiming" op de issue en stuur een DM naar **Hannes Rudolph (`hrudolph`)** op [Discord](https://discord.gg/superroo). De toewijzing wordt in de thread bevestigd.
...
Door bij te dragen, ga je ermee akkoord dat je bijdragen onder de Apache 2.0-licentie worden gelicentieerd, in overeenstemming met de licentieverlening van SuperRoo.
