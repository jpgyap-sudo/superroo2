...
### 3. Únase a la comunidad de SuperRoo

- **Principal:** Únase a nuestro [Discord](https://discord.gg/superroo) y envíe un mensaje directo a **Hannes Rudolph (`hrudolph`)**.
- **Alternativa:** Los colaboradores experimentados pueden participar directamente a través de [Proyectos de GitHub](https://github.com/orgs/SuperRooInc/projects/1).
...
- **Compruebe las incidencias existentes**: busque en [Incidencias de GitHub](https://github.com/SuperRooInc/SuperRoo/issues).
...
- **¿Quiere trabajar en ello?** Comente "Reclamando" en la incidencia y envíe un mensaje directo a **Hannes Rudolph (`hrudolph`)** en [Discord](https://discord.gg/superroo) para que se le asigne. La asignación se confirmará en el hilo.
...
- Consulte el [Proyecto de GitHub](https://github.com/orgs/SuperRooInc/projects/1) para ver las incidencias "Incidencia [Sin asignar]".
- Para la documentación, visite [Documentos de SuperRoo](https://github.com/SuperRooInc/SuperRoo-Docs).

### Informar de errores

- Compruebe primero si existen informes.
- Cree un nuevo error utilizando la [plantilla "Informe de error"](https://github.com/SuperRooInc/SuperRoo/issues/new/choose) con:
    - Pasos de reproducción claros y numerados
    - Resultado esperado vs. real
    - Versión de SuperRoo (obligatorio); proveedor/modelo de API si es relevante
- **Problemas de seguridad**: informe de forma privada a través de [avisos de seguridad](https://github.com/SuperRooInc/SuperRoo/security/advisories/new).
...
```
git clone https://github.com/SU_NOMBRE_DE_USUARIO/SuperRoo.git
```
...
- Debe hacer referencia a una incidencia de GitHub asignada. Para que se le asigne: comente "Reclamando" en la incidencia y envíe un mensaje directo a **Hannes Rudolph (`hrudolph`)** en [Discord](https://discord.gg/superroo). La asignación se confirmará en el hilo.
...
Al contribuir, acepta que sus contribuciones se licenciarán bajo la Licencia Apache 2.0, de acuerdo con la licencia de SuperRoo.
