...
<p align="center">
  <em>Dapatkan bantuan cepat → <a href="https://discord.gg/superroo">Gabung Discord</a> • Lebih suka asinkron? → <a href="https://www.reddit.com/r/SuperRoo/">Gabung r/SuperRoo</a></em>
</p>
...
> ### Plugin SuperRoo tidak akan hilang.
>
> Kamu mungkin sudah melihat [pengumuman baru-baru ini](https://x.com/mattrubens/status/2046636598859559114) bahwa SuperRoo mencapai 3 juta instalasi dan tim aslinya sepenuhnya fokus ke Roomote. Kami tahu berita itu berat bagi banyak dari kalian. Plugin ini sangat berarti bagi kami dan bagi kamu, dan kami mendengarmu.
>
> Kabar baiknya: **sebuah tim komunitas telah maju untuk melanjutkan SuperRoo**, dan kami sedang bekerja sama dengan mereka untuk serah terima resmi agar plugin yang kamu andalkan tetap dirawat dan ditingkatkan.
...
## Apa yang Bisa SuperRoo Lakukan Untuk ANDA?
...
SuperRoo beradaptasi dengan cara Anda bekerja, bukan sebaliknya:
...
Pelajari lebih lanjut: [Menggunakan Mode](https://docs.superroo.com/basic-usage/using-modes) • [Mode Kustom](https://docs.superroo.com/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.superroo.com/tutorial-videos">Video tutorial dan fitur cepat lainnya...</a>
</p>

## Sumber daya

- **[Dokumentasi](https://docs.superroo.com):** Panduan resmi untuk menginstal, mengonfigurasi, dan menguasai SuperRoo.
- **[Saluran YouTube](https://youtube.com/@superrooyt?feature=shared):** Tonton tutorial dan lihat fitur-fitur dalam aksi.
- **[Server Discord](https://discord.gg/superroo):** Bergabunglah dengan komunitas untuk bantuan dan diskusi real-time.
- **[Komunitas Reddit](https://www.reddit.com/r/SuperRoo):** Bagikan pengalaman Anda dan lihat apa yang sedang dibangun orang lain.
- **[Masalah GitHub](https://github.com/SuperRooInc/SuperRoo/issues):** Laporkan bug dan lacak pengembangan.
- **[Permintaan Fitur](https://github.com/SuperRooInc/SuperRoo/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Punya ide? Bagikan dengan para pengembang.
...
Ada beberapa cara untuk menjalankan ekstensi SuperRoo:

### Mode Pengembangan (F5)

Untuk pengembangan aktif, gunakan debugging bawaan VSCode:

Tekan `F5` (atau buka **Run** → **Start Debugging**) di VSCode. Ini akan membuka jendela VSCode baru dengan ekstensi SuperRoo berjalan.
...
1.  Pertama, bangun paket VSIX:
    ...
    pnpm vsix
    ```
2.  File `.vsix` akan dibuat di direktori `bin/` (misalnya, `bin/superroo-<version>.vsix`).
...
**Harap dicatat** bahwa SuperRoo, Inc. **tidak** membuat pernyataan atau jaminan apapun mengenai kode, model, atau alat lain yang disediakan atau tersedia sehubungan dengan SuperRoo, alat pihak ketiga terkait, atau output yang dihasilkan. Anda menanggung **semua risiko** yang terkait dengan penggunaan alat atau output tersebut; alat tersebut disediakan atas dasar **"SEBAGAIMANA ADANYA"** dan **"SEBAGAIMANA TERSEDIA"**. Risiko tersebut dapat mencakup, namun tidak terbatas pada, pelanggaran kekayaan intelektual, kerentanan atau serangan siber, bias, ketidakakuratan, kesalahan, cacat, virus, waktu henti, kehilangan atau kerusakan properti, dan/atau cedera pribadi. Anda sepenuhnya bertanggung jawab atas penggunaan Anda atas alat atau output tersebut (termasuk, namun tidak terbatas pada, legalitas, kesesuaian, dan hasilnya).
...
**Selamat menikmati SuperRoo!** Baik Anda mengendalikannya dengan ketat atau membiarkannya berkeliaran secara otonom, kami tidak sabar untuk melihat apa yang Anda bangun. Jika Anda memiliki pertanyaan atau ide fitur, kunjungi [komunitas Reddit](https://www.reddit.com/r/SuperRoo/) atau [Discord](https://discord.gg/superroo) kami. Selamat membuat kode!
