...
const initWorkspaceRepo = async ({
	workspaceDir,
	userName = "SuperRoo",
	userEmail = "support@superroo.com",
	...
	(klass, prefix) => {
		...
		describe(`${klass.name}#hasNestedGitRepositories`, () => {
			it("throws error when nested git repositories are detected during initialization", async () => {
				...
				await mainGit.init()
				await mainGit.addConfig("user.name", "SuperRoo")
				await mainGit.addConfig("user.email", "support@superroo.com")
				...
				await nestedGit.addConfig("user.name", "SuperRoo")
				await nestedGit.addConfig("user.email", "support@superroo.com")
